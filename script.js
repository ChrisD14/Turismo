...
// Guarda los datos de la encuesta en localStorage
function saveToLocalStorage() {
    localStorage.setItem('surveyData', JSON.stringify(surveyData));
}

// Carga los datos de la encuesta desde localStorage
...
// Función principal de inicialización al cargar el DOM
document.addEventListener('DOMContentLoaded', function() {
    ...
    const btnCargarExcel = document.getElementById('btnCargarExcel'); // Nuevo botón

    loadFromLocalStorage(); // Cargar datos al inicio en cualquier página
    ...
    if (btnGuardar && form) {
        btnGuardar.addEventListener('click', function() {
            ...
            const formData = {
                ...
                Timestamp: getCurrentDateTime() // Añadir marca de tiempo
            };

            surveyData.push(formData); // Añadir el nuevo registro
